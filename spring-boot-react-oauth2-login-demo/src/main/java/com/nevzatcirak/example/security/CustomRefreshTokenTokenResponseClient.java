...
public final class CustomRefreshTokenTokenResponseClient implements OAuth2AccessTokenResponseClient<OAuth2RefreshTokenGrantRequest> {
    ...
    @Autowired
    public CustomRefreshTokenTokenResponseClient(TokenService tokenService) {
