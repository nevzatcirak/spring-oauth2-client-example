...
import com.nevzatcirak.example.oauth2.util.OAuth2AuthorizedClientUtils;
...
public class DefaultOAuth2AuthorizedClientExchangeFilter implements ExchangeFilterFunction {
    ...
    public Mono<ClientResponse> filter(ClientRequest request, ExchangeFunction next) {
        ...
        OAuth2AuthorizedClient oauth2AuthorizedClient = OAuth2AuthorizedClientUtils.loadOAuth2AuthorizedClient(clientRegistrationId, principal, httpRequest);
